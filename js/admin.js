...
function handleProductSubmit(e) {
  ...
  if (base64Images.length === 0) {
    data.image = images.length > 0 ? images[0] : "https://placehold.co/500x650/0B1F3A/D8BD84?font=playfair-display&text=Caps";
    data.images = images;
...
function syncToFirebase() {
  ...
  fsLoadProducts(function (firestoreProducts) {
      ...
      var newProducts = PRODUCTS.filter(function (p) { return allBlockedIds.indexOf(p.id) === -1; });
